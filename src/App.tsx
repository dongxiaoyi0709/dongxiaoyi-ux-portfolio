...
const projectShowcases = [
  ...
  { brand: '希沃信鸽', website: 'https://yanxiu.seewo.com/pc/org/zhejiang', title: '数智化教研评审平台', detail: 'B 端后台 · 评课管理 · 研修管理', src: '/projects/seewo-xinge-platform.webp', gallery: 'szh' },
  { brand: 'seewo', website: 'https://teacher-digital.seewo.com/main', title: '教师数字素养平台', detail: '可视化大屏 · 人机对话系统 · AIGC', src: '/projects/seewo-digital-literacy.webp', gallery: 'literacy' },
  { brand: 'MBA 智库', website: 'https://www.mbalib.com/apps/mbalib/', title: 'MBA 智库 App', detail: '课堂 · 百科 · 文档 · 商学院', src: '/projects/mba-app.webp', gallery: 'mba' },
  { brand: '4Seller', website: 'https://www.4seller.com/en-US/home.html', title: '电商 ERP 系统', detail: '多平台聚合 · 订单管理 · 库存同步', src: '/projects/4seller-erp.webp', gallery: 'jb', galleryStart: 25 },
]
